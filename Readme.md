...
# Smoke Test Checklist
  ...
  ------------------------------------------------------------ ------------------
  Endpoint                                                     Expected
  GET http://localhost:9000/.well-known/openid-configuration   200
  GET http://localhost:8081/health                             200 {"tatus""P"}
  GET http://localhost:8080/health                             200
  GET http://localhost:8081/api/v1/accounts                    401
  GET http://localhost:8080/api/v1/accounts                    401 or redirect
